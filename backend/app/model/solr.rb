    ...
    def to_solr_url
      ...
      if @query_type == :edismax
        ...
        if @protect_unpublished
          add_solr_param(:qf, "qsa_id_u_stext^5 title_ws^2 finding_aid_filing_title^2 fullrecord_published")
        else
          add_solr_param(:qf, "qsa_id_u_stext^5 title_ws^2 finding_aid_filing_title^2 fullrecord")
        end
